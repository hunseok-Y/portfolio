	...
	return (
		<>
			...
			<div className="md:py-10 py-5 border-b-[0.5px] border-white">
				<ul>
					<li className="flex md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						...
						<div className="flex gap-x-2.5 gap-y-1.5 flex-wrap">
							...
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								...
								<span className="font-[700] md:text-[14px] text-[12px]">React</span>
							</div>
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								<div className="w-[14px] h-[14px]">
									<img src="/images/icon_html.png" alt="" className="object-center object-contain w-full h-full" />
								</div>
								<span className="font-[700] md:text-[14px] text-[12px]">HTML</span>
							</div>
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								<div className="w-[14px] h-[14px]">
					...
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">개발기간</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">2025. 06.28 ~ 2025. 08. 23</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">참여인원</div>
					...
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">기여도</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">3/5</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">카테고리</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">WEB</div>
					</li>
					<li className="flex md:items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">사이트</div>
			...
			<div className="md:py-10 py-5 border-b-[0.5px] border-white">
				<video src="/images/eum/video_sian.mp4" controls className="mx-auto md:h-[600px] h-auto"></video>
			</div>
			<div className="md:py-10 py-5">
				<div>
					<h2 className="content-title md:mb-2.5 mb-1.5">프로젝트 설명</h2>
