export default function Newsly() {
	return (
		<>
			<div className="md:h-[400px] h-[200px] md:rounded-[20px] rounded-[10px] overflow-hidden">
				<img src="/images/newsly/img_newsly.png" alt="" className="w-full h-full object-center object-cover" />
			</div>
			<div className="md:py-10 py-5 border-b-[0.5px] border-white">
				<ul>
					<li className="flex md:gap-x-10 gap-x-5">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[50px] w-full font-[700]">SKILLS</div>
						<div className="flex gap-x-2.5 gap-y-1.5 flex-wrap">
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								...
								<span className="font-[700] md:text-[14px] text-[12px]">JavaScript</span>
							</div>
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								<div className="w-[14px] h-[14px]">
									<img src="/images/icon_typescript.png" alt="" className="object-center object-contain w-full h-full" />
								</div>
								<span className="font-[700] md:text-[14px] text-[12px]">TypeScript</span>
							</div>
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								<div className="w-[14px] h-[14px]">
									<img src="/images/icon_next.svg" alt="" className="object-center object-contain w-full h-full" />
								</div>
								<span className="font-[700] md:text-[14px] text-[12px]">Next.js</span>
							</div>
							<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
								<div className="w-[14px] h-[14px]">
									<img src="/images/icon_tailwind.png" alt="" className="object-center object-contain w-full h-full" />
								</div>
								<span className="font-[700] md:text-[14px] text-[12px]">Tailwind</span>
							</div>
						</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 mt-1.5">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[54px] w-full font-[700] ">DATA</div>
						<div className="bg-white inline-flex items-center gap-x-1 px-2 py-0.5 rounded-[6px]">
							<div className="w-[14px] h-[14px]">
								<img src="/images/icon_mongodb.png" alt="" className="object-center object-contain w-full h-full" />
							</div>
							<span className="font-[700] md:text-[14px] text-[12px]">MongoDB</span>
						</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[16px] text-white md:max-w-[64px] max-w-[56px] w-full font-[700] ">개발기간</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">2025. 09.28 ~ 2025. 10. 10</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[16px] text-white md:max-w-[64px] max-w-[56px] w-full font-[700] ">참여인원</div>
					...
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[16px] text-white md:max-w-[64px] max-w-[56px] w-full font-[700] ">기여도</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">5/5</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 md:mt-1.5 mt-2">
						<div className="md:text-[18px] text-[16px] text-white md:max-w-[64px] max-w-[56px] w-full font-[700] ">카테고리</div>
						<div className="md:text-[16px] text-[14px] text-white font-[400]">WEB</div>
					</li>
					<li className="flex items-center md:gap-x-10 gap-x-5 mt-1.5 ">
						<div className="md:text-[18px] text-[14px] text-white md:max-w-[64px] max-w-[54px] w-full font-[700] ">사이트</div>
						<div className="flex items-center gap-x-2.5">
							...
							<a
								...
								<span className="font-[700] md:text-[14px] text-[12px]">사이트 바로가기</span>
							</a>
						</div>
					</li>
				</ul>
			...
			<div className="md:py-10 py-5">
				...
				<div className="md:mt-10 mt-5">
					<h2 className="content-title md:mb-2.5 mb-1.5">구현 기능</h2>
					<ul className="dot">
				...
				<div className="md:mt-10 mt-5">
					<h2 className="content-title md:mb-2.5 mb-1.5">문제점 & 해결방법</h2>
					<ul>
						<li>
							<h4 className="content-title">1. 무한스크롤 데이터 중복으로 불러오기</h4>
							<div className="md:mt-2.5 mt-1.5">
								<p className="text-white md:text-[16px] text-[14px] font-[300]">
